$(document).ready(function() {
        ...
        function callback_edit_office( returned_data ) {
             $("#edit_changeoffice").empty();
             $('input[name="id"]:checked').parent().parent().replaceWith( returned_data );
        }
